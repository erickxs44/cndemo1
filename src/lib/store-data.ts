...
export const BRANDS = [
  ...
  { slug: "reserva", name: "Reserva", tagline: "Brasilidade Premium", description: "Estilo brasileiro com alma autêntica. Peças que contam histórias." },
  { slug: "aramis", name: "Aramis", tagline: "Refined Menswear", description: "Modernidade e elegância em equilíbrio perfeito. Para quem entende de estilo." },
];
...
export const PRODUCTS: Product[] = [
  ...
  { id: "3", variantId: "10003", name: "Bermuda Chino Sarja", brand: "Aramis", category: "bermudas", price: 329, image: bermuda1, colors: [{name:"Caqui",hex:"#c8a878"},{name:"Marinho",hex:"#1a2540"}], sizes: ["38","40","42","44","46"], description: "Sarja de algodão pesado com elastano. Conforto e elegância para o dia a dia." },
  { id: "4", variantId: "10004", name: "Calça Alfaiataria Slim", brand: "Emporio Armani", category: "calcas", price: 899, image: pants1, colors: [{name:"Preto",hex:"#000"},{name:"Marinho",hex:"#0a1530"}], sizes: ["38","40","42","44","46","48"], description: "Lã italiana fria com toque sedoso. Corte slim moderno com bainha viva.", isNew: true },
  { id: "5", variantId: "10005", name: "Polo Manga Curta Pima", brand: "Reserva", category: "polos", price: 389, image: polo2, colors: [{name:"Marinho",hex:"#0a1530"},{name:"Bordô",hex:"#5a0e1e"}], sizes: baseSizes, description: "Algodão Pima de fibra longa. Toque macio e durabilidade superior." },
  { id: "6", variantId: "10006", name: "Camisa Oxford Tailored", brand: "Aramis", category: "camisas", price: 549, oldPrice: 699, image: shirt2, colors: [{name:"Grafite",hex:"#2a2a2e"},{name:"Preto",hex:"#000"}], sizes: baseSizes, description: "Tecido oxford encorpado, corte tailored. Versatilidade entre o casual e o social.", isNew: true },
];
